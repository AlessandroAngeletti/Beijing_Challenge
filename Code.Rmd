...
According to the coefficients of `neighbourhood_simplifiedRing x` above, our hypothesis is true. For example, in Ring 2 the intercept term is 6.96. The negative sign in coefficients of Ring 3, 4, 5 and 6 indicates that the intercept term will be lower by 0.2, 0.18, 0.2 and 0.297 respectively. So, further the property from central Beijing, lower the `price_4_nights`.  
