...
Next we need to check for missing values, as this can ruin our data analysis.
...
```{r}
model2 <- lm(data = regression_data, price_4_night ~ prop_type_simplified + number_of_reviews + review_scores_rating + room_type)
...
```{r}
model3 <- lm(data = regression_data, price_4_night ~ prop_type_simplified + number_of_reviews + review_scores_rating + room_type - prop_type_simplified)
msummary(model3)
```
