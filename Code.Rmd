...
p1 <- ggplot(data = data_cleaned, aes(x = price)) +
  geom_density() +
  theme_bw() +
  labs(title = "Variability of Price", subtitle = "Difficult to read due to outliers with high prices", x = "Price ($)", y = "Density")
```
...
p1a + p2a + p3a + p4a + p5a + p6a + p7a + p8a + p9a + p10a + p11a +
  plot_annotation(title = "Variability in Numerical Variables", subtitle = "Majority of numerical variables are highly right-skewed")
